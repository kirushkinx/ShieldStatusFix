...
Starting 1.21.5 version, changes in packet handling broke shield status mods for players on older client versions. This plugin fixes the issue by manually sending the entity status packet (byte 30) when a shield is disabled by an axe hit.
